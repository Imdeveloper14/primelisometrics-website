...
export default function Navbar({ isLoaded = true }: NavbarProps) {
  ...
  useEffect(() => {
    ...
    if (path.includes('/calculators') || path.includes('/calculator') || path.includes('/savitsky-calculator') || path.includes('/holtrop-calculator') || path.includes('/froude-calculator') || path.includes('/william-froude-calculator')) {
